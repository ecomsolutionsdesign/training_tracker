...
export default function ReportsPage() {
    ...
    const exportTrainingSummary = () => {
        ...
        downloadCSV(csvContent, `training-report-${new Date().toISOString().split('T')[0]}.csv`);
    };
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <div className="font-semibold text-lg text-green-900">📈 Training Summary Report</div>
                                    <div className="text-sm text-green-700 mt-1">Overall training statistics</div>
                                </div>
                            </div>
                        </button>
