...
//       const url =
//         department !== 'All'
//           ? `/api/topics?department=${department}`
//           : '/api/topics';
...
//         }
//         : { topic: '', department: '', duration: '', trainerName: '' }
//     );
//     setShowModal(true);
//   };
...
//     setShowModal(false);
//     setEditItem(null);
//     setTopicForm({ topic: '', department: '', duration: '', trainerName: '' });
//   };
...
//               Training Topics ({filteredTopics.length})
//             </h2>
//             <button
//               onClick={() => openModal()}
...
//                           <User className="w-3 h-3 text-gray-400" /> {topic.trainerName}
//                         </span>
//                       ) : (
//                         <span className="text-gray-400 text-sm">—</span>
//                       )}
...
//                       onChange={(e) =>
//                         setTopicForm({ ...topicForm, department: e.target.value })
//                       }
//                       className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 outline-none"
//                     >
...
//                       onChange={(e) =>
//                         setTopicForm({ ...topicForm, duration: e.target.value })
//                       }
//                       className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 outline-none"
//                     >
...
//                       value={topicForm.trainerName}
//                       onChange={(e) =>
//                         setTopicForm({ ...topicForm, trainerName: e.target.value })
//                       }
//                       className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 outline-none"
//                     />
//                     <p className="text-xs text-gray-500 mt-1">
//                       This trainer will appear in the Training Program PDF.
//                     </p>
//                   </div>
//                 </div>
...
export default function TopicsPage() {
  ...
  const [topicForm, setTopicForm] = useState({
    ...
    department: '',
    duration: '',
    trainer: '',    // NOW an ObjectId string
  });
